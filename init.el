...
(919)886-6533")
 ...
 '(rcirc-server-alist (quote (("irc.freenode.net" :channels ("#rcirc" "#emacs" "#leiningen" "#clojure" "#python" "#bitcoin")) ("irc.devel.redhat.com" :channels ("#satellite6-qe" "#candlepin" "#cloud-qe" "#rdu16ne" "#rdu" "#cfme-qe" "#cfme-eng") nil nil))))
