...
#+BEGIN_SRC emacs-lisp
  ...
  (setq
   ...
   smtpmail-smtp-user "postmaster@mailgun.jweiss.com")
#+END_SRC
...
As an experiment, let's also add mu4e. It needs to be installed from
the linux tarball, it's not an elpa package. So we just load it from
it's existing location:

#+BEGIN_SRC emacs-lisp
  (add-to-list 'load-path "/usr/local/share/emacs/site-lisp/mu4e")
  (require 'mu4e)
  (setq mu4e-maildir "/home/jweiss/Mail")
  ;; fast index
  (setq
